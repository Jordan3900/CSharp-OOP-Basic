...
namespace Forum.Data
{
    public class DataMapper
    {
        ...
        private const string CONFIG_PATH = "confing.ini";
        ...
        static DataMapper()
        {
            ...
            config = LoadingConfig(DATA_PATH + CONFIG_PATH);
        }
        ...
        private static Dictionary<string, string> LoadingConfig(string configPath)
        {
        ...
        public static List<Reply> LoadReply()
        {
            ...
            foreach (var line in dataLines)
            {
                ...
                var postsId =int.Parse( args[3]);
                Reply reply = new Reply(id, content, authorId, postsId);
        ...
        public static void SaveReply(List<Reply> replies)
        {
            ...
            foreach (var reply in replies)
            {
                ...
                string line = string.Format(postFormat, reply.Id, reply.AuthorId, reply.Content, string.Join(",",reply.PostId));
